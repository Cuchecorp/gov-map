...
export const MANIFIESTO = [
  ...
  e({ id: "4.1-A3-S-sin-cruces", inventarioRef: ["4.1-A3"], origen: P_SEN, href: null, tipo: "ausencia", espera: 'id="cruces"', destino: P_SEN, gate: "CRUCES",
      nota: "Diferencia por sujeto (§4.1): con S1338 la <section id=\"cruces\"> no pinta detalle (conteos.cruces.tipo !== 'dato', page.tsx:682) ⇒ A3 no ofrece #cruces" }),
