...
/**
 * error — frontera de error honesta para /contraparte/[id].
 ...
 * ERROR (fallo) de un dato ausente. No expone detalle técnico ni dato de contraparte.
 * Espejo de /parlamentario/[id]/error.
 */
export default function ContraparteError({
  error,
  unstable_retry,
}: {
  ...
  return (
    <main className="max-w-3xl mx-auto px-4 md:px-8 py-16 text-center">
      ...
      <p className="text-base leading-relaxed text-muted-foreground mt-4">
        ...
        ausencia de información: no asumas que no hay contratos ni aportes.
      </p>
