/**
 * Detector de número de boletín en tres formatos (RETR-01):
 ...
 *
 * La regex BOLETIN_RE en app/lib/buscar.ts (/^\d{3,6}(-\d{1,2})?$/) NO cubre el
 ...
 *
 * Función pura, sin imports — fuente única (#36) para el árbol app/ del detector
 * de boletines con soporte de formato punteado (portada de packages/fichas/src/spike/boletin.ts).
 */
