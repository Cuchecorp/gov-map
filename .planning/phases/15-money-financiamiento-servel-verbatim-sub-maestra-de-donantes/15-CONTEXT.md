...
- Fuente/formato: `servel.cl` / `aportes.servel.cl` (agregar al allowlist `DEFAULT_ALLOWED_SUFFIXES`); parse **verbatim sin LLM**; el formato real (Excel/CSV/HTML descargable por elección) lo confirma research.
