...
- [ ] **LEGAL-03**: Toda columna PII nueva queda oculta a `anon` por RLS (igual que `parlamentario.rut`) y la compuerta `data-routing` del LLM se extiende a los nuevos datos sensibles (ningún RUT/PII llega al LLM).
