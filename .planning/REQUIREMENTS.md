...
- [x] **AUTOR-02**: La ficha de proyecto muestra autoría (F48 diferida de v5): autores con guarda de identidad (link solo si confirmado, IdentityMarker si no) + fuente/fecha/enlace, montada sobre el patrón drill-down de F55.
