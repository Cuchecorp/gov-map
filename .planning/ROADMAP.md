...
- 🚧 **v8.1 — Demo perfecto** — Phases 82-85 (copy mockup, crons sanos + datos frescos diarios, deuda técnica cero, seguridad + ship) — lectura fría del operador 2026-07-15
...
- [ ] **Phase 82: DEMO-COPY — Textos del mockup en la home** — h1/subtítulo/botón "Buscar" del mockup; tile verde variante linter-safe; tests de copy actualizados; anti-insinuación verde. (DEMO-01)
...
- [ ] **Phase 83: CRON-SALUD — Crons sanos + datos frescos** — reparar lobby-camara (estrategia anti-WAF vía curl o fail-loud con runbook local) y probidad (root cause "0 consultados"); cadencia diaria L-V para leyes-weekly; refresco para la fuente de fichas Senado; matriz fuente→workflow→cadencia. (DEMO-02)
...
- [ ] **Phase 84: DEUDA-CERO — Revisión completa + eliminación de deuda técnica** — tech debt v8.0 (test contraste dark), revisión ruta-por-ruta de textos/estados/consistencia, deuda P3 /red si barata, backlog code-side. (DEMO-03)
...
- [ ] **Phase 85: SEC-SHIP — Seguridad + deploy final** — revisión de seguridad (posture Supabase/RLS vía supabase-reviewer, headers worker, secrets en workflows, CodeQL), deploy final, verificación visual, tag. (DEMO-04)
