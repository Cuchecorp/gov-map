...
- [ ] **Phase 6: Citaciones + Tabla Semanal de Sala** - Conectores frágiles (HTML de Cámara tras Cloudflare + API backend del Senado) con agenda de comisiones y sala
...
| 6. Citaciones + Tabla Semanal de Sala | 3/4 | In Progress|  |
