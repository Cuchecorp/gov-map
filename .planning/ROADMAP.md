...
- [x] 15-03-PLAN.md — Sección `/parlamentario/[id]` "Aportes de campaña registrados en SERVEL": carril propio (mt-12) gateado por moneyPublicEnabled() (default OFF, heading ausente del HTML), 3 estados honestos, agrupación por periodo electoral + caveat de candidatura anterior, donante como sujeto propio (RUT nunca renderizado), atribución "términos por verificar", rama SERVEL en sourceLabel; enlace por NOMBRE confirmado (A1, no por RUT); 20 tests RTL verdes, tsc limpio
