...
**Plans:** 4 plans
Plans:
- [ ] 03-01-PLAN.md — @obs/identity + normalizarNombre + matchDeterminista (lógica pura fail-closed, tests golden) (ID-02)
- [ ] 03-02-PLAN.md — Migración 0005 parlamentario + parlamentario_alias + RLS deny-by-default + pgTAP (ID-01)
...
| 3. Tabla Maestra Parlamentario + Identidad Determinista | 0/4 | Planned | - |
